...
urlpatterns = [
    ...
    path("OutItemDelHblHawb/<PermitId>/", views.OutDelHblHawb.as_view()),
    path("OutItem/", views.OutItem.as_view()),
    path("OutItemCodeSave/", views.ItemCodeSave.as_view()),
    ...
    path('outShow/<id>/', views.Outshow.as_view()),
    path("outTransmit/", views.outTransmit),
    path('OutDelete/<id>/',views.OutDelete.as_view()),
    path("OutTransmitData/", views.OutMailTransmitData.as_view()),
]
